...
rightWall = sphere (3,point (0,0,0) ,1.0 , leftWallTransformation ,m)
    where m = material (Colors.color 1 0.9 0.9 1, 0.1, 0.9, 0.0, 200.0)
...
world2 = world [(Object floor'), (Object leftWall), (Object rightWall), (Object middle), (Object left), (Object right)] [(pointLight (point (-10, 10, -10), Colors.color 1 1 1 0)), (pointLight (point (10, 10, -10), Colors.color 1 1 1 0))]
-- world' = defaultWorld
